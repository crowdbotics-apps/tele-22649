...
admin.site.site_header = "tele"
admin.site.site_title = "tele Admin Portal"
admin.site.index_title = "tele Admin"

# swagger
api_info = openapi.Info(
    title="tele API",
    default_version="v1",
    description="API documentation for tele App",
)
